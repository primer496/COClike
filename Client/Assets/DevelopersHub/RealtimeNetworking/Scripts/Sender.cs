namespace DevelopersHub.RealtimeNetworking.Client
{
    ...
    public class Sender : MonoBehaviour
    {
        ...
        private static void SendTCPData(Packet _packet)
        {
            ...
            if (Client.instance == null || Client.instance.tcp == null || !Client.instance.isConnected)
            {
                Debug.LogWarning("TCP send skipped: client is not connected.");
                return;
            }
        ...
        private static void SendUDPData(Packet _packet)
        {
            ...
            if (Client.instance == null || Client.instance.udp == null || !Client.instance.isConnected)
            {
                Debug.LogWarning("UDP send skipped: client is not connected.");
                return;
            }
