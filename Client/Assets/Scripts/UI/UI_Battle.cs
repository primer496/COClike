namespace DevelopersHub.ClashOfWhatecer
{
    ...
    {
        // ‚î¢„‚î¢„ Profiler ÈááÊ†∑ËäÇÁÇπ ‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„
        private static readonly Unity.Profiling.ProfilerMarker s_SimTick         = new Unity.Profiling.ProfilerMarker(Unity.Profiling.ProfilerCategory.Scripts, "UI_Battle.SimTick");
        private static readonly Unity.Profiling.ProfilerMarker s_UpdateUnitsUI   = new Unity.Profiling.ProfilerMarker(Unity.Profiling.ProfilerCategory.Scripts, "UI_Battle.UpdateUnits");
        private static readonly Unity.Profiling.ProfilerMarker s_UpdateBuildingsUI = new Unity.Profiling.ProfilerMarker(Unity.Profiling.ProfilerCategory.Scripts, "UI_Battle.UpdateBuildings");
        // ‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„‚î¢„
        ...
        public void NoTarget()
        {
            ...
            switch (Language.instanse.language)
            {
                case Language.LanguageID.persian:
                    MessageBox.Open(1, 0.8f, true, MessageResponded, new string[] { "ÿØÿ± ÿ≠ÿßŸÑ ÿ≠ÿßÿ∂ÿ± ŸáÿØŸÅ€å ÿ®ÿ±ÿß€å ÿ≠ŸÖŸÑŸá Ÿæ€åÿØÿß ŸÜÿ¥ÿØ." }, new string[] { "ÿ®ÿßÿ¥Ÿá" });
                    break;
                default:
        ...
        public bool Display(Data.Player player, List<Data.Building> buildings, long defender, Data.BattleType battleType)
        {
            ...
            if (units.Count <= 0)
            {
                ...
                {
                    case Language.LanguageID.persian:
                        MessageBox.Open(1, 0.8f, true, MessageResponded, new string[] { "Ÿá€å⁄Ü ÿ≥ÿ±ÿ®ÿßÿ≤€å ÿ®ÿ±ÿß€å ÿ≠ŸÖŸÑŸá ŸÜÿØÿßÿ±€åÿØ." }, new string[] { "ÿ®ÿßÿ¥Ÿá" });
                        break;
                    default:
            ...
            {
                case Language.LanguageID.persian:
                    _timerDescription.text = "ÿ≤ŸÖÿßŸÜ ÿ™ÿß ÿ¥ÿ±Ÿàÿπ ÿ≠ŸÖŸÑŸá:";
                    break;
                default:
        ...
        private void StartBattle()
        {
            ...
            {
                case Language.LanguageID.persian:
                    _timerDescription.text = "ÿ≤ŸÖÿßŸÜ ÿ™ÿß Ÿæÿß€åÿßŸÜ ÿ≠ŸÖŸÑŸá:";
                    break;
                default:
        ...
        public bool PlaceUnit(int x, int y)
        {
        ...
        private void Update()
        {
            if (battle != null && battle.end == false)
            {
                if (isStarted)
                {
                    ...
                    if (frame > battle.frameCount)
                    {
                        if (toAddUnits.Count > 0 || toAddSpells.Count > 0)
                        {
                            ...
                            {   //Ω´“™ÃÌº”µƒµ•ŒªÃÌº”µΩ’Ω∂∑÷–£¨≤¢Ω´À¸√«ÃÌº”µΩ’Ω∂∑÷°÷–∑¢ÀÕ∏¯∑˛ŒÒ∆˜
                        ...
                        using (s_SimTick.Auto()) { battle.ExecuteFrame(); }
                ...
                using (s_UpdateUnitsUI.Auto()) { UpdateUnits(); }
                using (s_UpdateBuildingsUI.Auto()) { UpdateBuildings(); }
            }
        }
